...
def sirhd_odes(t, x, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15, b16, b17, b18, g, h, d):
    # Compartments
    S = x[0]  # Susceptible
    I = x[1]  # Infected
    R = x[2]  # Recovered
    ...
    bs = 7*[b1] + 7*[b2] + 7*[b3] + 7*[b4] + 7*[b5] + 7*[b6] + 7*[b7] + 7*[b8] + 7*[b9] + 7*[b10] + 7*[b11] + 7*[b12] + 7*[b13] + 7*[b14] + 7*[b15] + 7*[b16] + 7*[b17] + 5*[b18]
